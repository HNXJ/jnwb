...
if ~exist([spk_file_path_itt filesep 'rez2.mat'], 'file') | respike_sort
    ...
    while spike_sorting_incomplete
        ...
        try
            ...
            json_struct.noise_waveform_params.multiprocessing_worker_count = 2;
            ...
            fprintf(fid, '%s\n', ['python "' pp.REPO 'run_ecephys_module.py" ecephys_spike_sorting.modules.kilosort_postprocessing --input_json ' ...
                spk_file_path_itt 'ecephys_spike_sorting_input.json --output_json ' spk_file_path_itt 'ecephys_spike_sorting_kspp_output.json']);
            fprintf(fid, '%s\n', ['python "' pp.REPO 'run_ecephys_module.py" ecephys_spike_sorting.modules.mean_waveforms --input_json ' ...
            ...
            fprintf(fid, '%s\n', ['python "' pp.REPO 'run_ecephys_module.py" ecephys_spike_sorting.modules.noise_templates --input_json ' ...
                spk_file_path_itt 'ecephys_spike_sorting_input.json --output_json ' spk_file_path_itt 'ecephys_spike_sorting_noise_output.json']);
            fprintf(fid, '%s\n', ['python "' pp.REPO 'run_ecephys_module.py" ecephys_spike_sorting.modules.quality_metrics --input_json '...
