...
%             intan_code_values_2 = [intan_code_values(3:end); NaN; NaN];
%             intan_code_values_3 = [NaN; NaN; intan_code_values(1:end-2)];
%             temp_idx = (intan_code_values_2 == 2002) & (intan_code_values_2 == 2002) & (intan_code_values == 2001);
%             intan_code_values(temp_idx) = 2003;
...
%             end
        ...
        for jj = 1 : numel(event_data)
            ...
            try
                ...
                warning("--->On task " + num2str(jj) + " events might not be aligned with the same number of elements. (Code 2xDIO-1)");
                warning("--->Task " + num2str(jj) + " event codes might be invalid.");
            end
