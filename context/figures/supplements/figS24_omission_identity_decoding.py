#!/usr/bin/env python3
"""
Generate Supplementary Figure S24: Omission Identity Decoding & GLMM Encoding.

Visualizes noise-controlled, cross-validated classification of "what was omitted?"
(Omitted A [AXAB] vs. Omitted B [BXBA] vs. Control [RXRR]) across time, space, and GLMM spatial hierarchy.

Outputs:
  - context/figures/supplements/figS24_omission_identity_decoding.png (300 DPI)
  - context/figures/supplements/figS24_omission_identity_decoding.svg
"""
...
SUPP_DIR = REPO_ROOT / "context" / "figures" / "supplements"
SUPP_DIR.mkdir(parents=True, exist_ok=True)

PNG_PATH = SUPP_DIR / "figS24_omission_identity_decoding.png"
SVG_PATH = SUPP_DIR / "figS24_omission_identity_decoding.svg"
...
def build_figS24():
    ...
    print(f"Successfully generated Supplementary Figure S24:")
