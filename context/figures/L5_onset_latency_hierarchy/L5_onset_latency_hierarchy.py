...
WHY THIS IS THE HIGHEST-STAKES SCRIPT IN THE LFP TRACK -- READ BEFORE EDITING
    ...
    3. Pooling (trials, then channels -- canonical method (a) from L0) happens on the rectified
       ...
       per trial-channel).
    4. Smoothing: `jnwb.onset_fitting.causal_exp_smooth` -- the SAME forward-only kernel already
    ...
    5. Fitting: `jnwb.onset_fitting.fit_exponential_onset` -- t0 is causality-bounded BY
