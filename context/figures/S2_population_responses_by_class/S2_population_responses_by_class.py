...
Reuses jnwb.unit_classification (unmodified): GLO_CONDITIONS, stimulus_present_events,
...
def build_stats(run_out: dict) -> dict:
    ...
    return {
        ...
        "class_definitions": {
            "S+": "is_s_plus (jnwb.unit_classification, unmodified)",
            "S-": "is_s_minus (jnwb.unit_classification wrapper, min_baseline_for_s_minus_hz gate dropped per S1)",
