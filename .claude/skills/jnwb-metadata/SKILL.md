...
units_df = get_all_units_metadata(oa.paths.nwb_dir() / 'sub-C31o_ses-230630_rec.nwb')
...
```python
elec_df = electrode_inventory(oa.paths.nwb_dir() / 'sub-C31o_ses-230630_rec.nwb')
...
```python
audit = audit_session(oa.paths.nwb_dir() / 'sub-C31o_ses-230630_rec.nwb')
