...
0.2.4-04 and 0.2.4-09 are closed. Remaining: 02 (one editorial documentation pass), 16 (final
independent critic against the exact candidate), then 01 and the release. No new features, no
optimization projects, no speculative API changes.
