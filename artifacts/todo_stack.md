...
Release: required-0.2.6.
Role: critic. Skill: none. Blocked by: 06-17, 06-53, 06-59, 06-129, 06-136, 06-141. Writes: none.
...
| one precision switch and one execution switch; CPU, parallel CPU and CUDA exercised here | 06-56 (now closed), 06-59 |
