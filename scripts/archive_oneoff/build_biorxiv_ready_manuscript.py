...
def build_biorxiv_ready_docx():
    print("==========================================================")
    print("      BUILDING BIORXIV-READY MANUSCRIPT (.DOCX)           ")
    print("==========================================================")

    # Load Empirical Census Data
    ...
    # Save to context/omission-2026-draft-biorxiv-ready.docx
    out_biorxiv = r'D:\workspace\omission\context\omission-2026-draft-biorxiv-ready.docx'
    doc.save(out_biorxiv)
    print(f"Successfully built bioRxiv-Ready Manuscript -> {out_biorxiv}")

    return out_biorxiv

def create_biorxiv_node():
    lab_dir = r'D:\workspace\omission\artifacts\.lab'
    os.makedirs(lab_dir, exist_ok=True)

    node = {
        "id": "context-biorxiv-ready-manuscript",
        "kind": "evidence",
        "title": "bioRxiv-Ready Manuscript & Draft Assets Portfolio",
        "generated": {
            "date": "2026-07-26",
            "links": [
        ...
        "issues": [],
        "plan": ["Use for bioRxiv preprint submission and journal peer review."],
        "verification": {
            "sources_resolve": True,
            "reproducible": True,
            "hash": "sha256_biorxiv_ready_20260726"
        }
    }

    out_node_path = os.path.join(lab_dir, "context-biorxiv-ready-manuscript.json")
    with open(out_node_path, "w", encoding="utf-8") as f:
        json.dump(node, f, indent=2)

    print(f"Saved Labyrinth bioRxiv node -> {out_node_path}")

if __name__ == '__main__':
    build_biorxiv_ready_docx()
    create_biorxiv_node()
