...
Scope (see artifacts/developer/progress.json entry for this script — do not expand):
  ...
  - This does NOT replace jnwb.session.OmissionSession's lazy h5py/pynwb access; it
...
Inputs:
  ...
  - jnwb.session.OmissionSession             (get_epochs for trial onsets, get_spike_times per unit;
