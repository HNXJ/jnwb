...
notebook_json = {
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Load stable units and pick top S+ / S- per area by SNR\n",
    ...
    "    if len(area_sp) > 0:\n",
    "        sp_units.append(area_sp.sort_values(\"snr\", ascending=False).iloc[0])\n",
    ...
    "    if len(area_sn) > 0:\n",
    "        sn_units.append(area_sn.sort_values(\"snr\", ascending=False).iloc[0])\n",
