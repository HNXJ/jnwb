...
sliding-window jnwb.decoding.decode_omission_presence pipeline (nested-CV SVM, 5-fold).
...
Real sliding-window SVM decoding (`jnwb.decoding.decode_omission_presence`, nested 5-fold CV),
