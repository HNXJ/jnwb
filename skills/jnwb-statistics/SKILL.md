...
1. **Exchangeability**: for grouped data (trials nested in sessions or blocks), use `scheme="within_group"` with explicit `groups`. Never permute globally when trial structure induces correlation.
