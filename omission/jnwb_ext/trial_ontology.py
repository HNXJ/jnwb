...
THE PARADIGM
    ...
    explicitly, matching them against omission.jnwb_ext.omission_identity.OMISSION_IDENTITY_CONDITIONS as an
...
def build_trial_ontology(
    ...
    (omission.jnwb_ext.omission_identity.detect_trial_cycles) -- computed per slot_key, since cycle
    ...
    """
    from omission.jnwb_ext.omission_identity import OMISSION_IDENTITY_CONDITIONS, detect_trial_cycles
