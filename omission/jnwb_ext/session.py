...
from jnwb.paths import REPO_ROOT as _REPO_ROOT
...
class OmissionSession:
    ...
    def lfp_tfr_trace_suite_omission(self, area: str, layer: str, session_specific: bool = True, **kwargs) -> Dict:
        ...
        Args:
            ...
            **kwargs: Arguments to pass to omission.jnwb_ext.viz.lfp_tfr_trace_suite_omission
    ...
    def lfp_tfr_trace_correlation(self, band_name: str, **kwargs) -> Dict:
        ...
        Args:
            ...
            **kwargs: Arguments to pass to omission.jnwb_ext.viz.lfp_tfr_trace_correlation
