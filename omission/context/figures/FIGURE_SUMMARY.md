...
| 4 | Leakage-safe omitted-identity decoding | SPK/SUA decoding across p2/p3/p4 with leave-one-temporal-cycle-out CV, within-cycle label-permutation null, held-out confusion, and ROC provenance | **P0 rerun in progress.** The prior random-CV `_v2` mean (`0.601284`) is confounded; the existing cycle-deconfounded p2 mean (`0.494627`) is approximately chance. | session-level aggregation; complete corpus receipt pending | **PROMOTED 2026-08-06**, not locked | **P0 leakage-safe rerun in progress** |
