...
_fig04.CONDITION_MAPS = os.path.join(REPO, "outputs", "condition_tfr_maps_p1d1p2d2p3_v2", "maps.npz")

P2_WINDOW_MS = (1031.0, 1562.0)
WINDOW_BIN_MS = 150.0
OUT_DIR = os.path.join(REPO, "outputs", "fig04_glmm_all_areas_timeresolved_v2")
