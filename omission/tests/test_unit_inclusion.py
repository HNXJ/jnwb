"""Unit tests for the S1 likelihood-of-firing unit-inclusion criterion (omission.jnwb_ext.unit_inclusion)."""
...
from omission.jnwb_ext.unit_classification import GLO_CONDITIONS, OM_BASE_GAP_MS, SLOT_WINDOW_MS
