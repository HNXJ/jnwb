...
from omission.jnwb_ext.artifact_repair import (interpolate_intervals as _jnwb_interpolate_intervals,
...
def interpolate_intervals(seg, fs, intervals_local):
    """Thin wrapper over omission.jnwb_ext.artifact_repair.interpolate_intervals, keeping this file's
