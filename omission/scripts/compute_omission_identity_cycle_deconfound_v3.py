...
WHAT THIS SCRIPT ADDS (per direction)
    1. Real cycle detection (omission.jnwb_ext.omission_identity.detect_trial_cycles) instead of an
...
from omission.jnwb_ext.omission_identity import decode_identity_cycle_deconfound  # noqa: E402
