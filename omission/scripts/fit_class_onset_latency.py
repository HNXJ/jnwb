...
ALIGNMENT
    S classes and omnibus: p1 onset (t=0ms, omission.jnwb_ext.sequence_layout.EPOCH_ONSETS_MS["p1"]), i.e.
...
#     of the smoothing bug. omission.jnwb_ext.sequence_layout.EPOCH_ONSETS_MS puts fixation acquisition
