...
from omission.jnwb_ext.analog import (  # noqa: E402
    _trial_table,
    load_lfp_epochs,
    load_muae_epochs,
)
...
def run(
    *,
    ...
    receipt = {
        ...
        "muae_accessor": {
            "module": "omission.jnwb_ext.analog",
            ...
            "area_addressing": "electrode table + probe-local channel position via omission.jnwb_ext.sequence_layout",
