...
FIGURE_SCRIPTS = [
    ...
    ("Figure 3", "scripts/build_figure3_raster_grid.py"),
    ...
    ("Figure 8", "scripts/build_granger_connectivity_grid.py"),
    ("Figure 9", "scripts/build_manuscript_figure9.py"),
    ("Figure 10", "scripts/build_manuscript_figure10.py"),
