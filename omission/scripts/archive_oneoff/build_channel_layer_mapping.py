...
# parents[2]: this file lives in scripts/archive_oneoff/, so the repo root is two levels up.
# (parents[1] was correct only while the script sat directly in scripts/.)
