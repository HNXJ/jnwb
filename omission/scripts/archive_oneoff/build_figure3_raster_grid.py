...
omission.jnwb_ext.sequence_layout.EPOCH_ONSETS_MS, matching the established 4624ms total span used
...
rate (omission.jnwb_ext.unit_classification.SLOT_WINDOW_MS, i.e. the same [p_n, p_n+531ms) window used by
