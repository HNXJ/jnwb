...
(omission.jnwb_ext.session.OmissionSession.lfp_tfr_trace_suite_omission, backed by real
...
def run_one_session(nwb_path: Path, area: Optional[str], layers: List[str],
    ...
    lines = [
        ...
        "",
        "Source: `omission.jnwb_ext.session.OmissionSession.lfp_tfr_trace_suite_omission` "
