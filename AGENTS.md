...
| `artifacts/goal.md` | The statement 0.2.6 is measured against (§2). Ruled, not inferred |
...
| `artifacts/evidence/0.2.6/` | Working evidence the current cycle's items cite |
