...
| jnwb.directed_network | function | directed_network(signals, method: 'str' = 'granger', labels: 'Optional[Sequence[str]]' = None, fdr: 'bool' = True, fdr_method: 'str' = 'bh', n_jobs: 'int' = 1, **kwargs) -> 'Dict[str, Any]'<br>*All-pairs directed connectivity over N nodes.* |
